package com.guohuayu.android.widget;
...
import com.baronzhang.android.widget.R;
...
public class TitleView extends LinearLayout {
    ...
    private void initView() {
        //根标签是merge：只能作为XML布局的根标签使用。当Inflate以开头的布局文件时，必须指定一个父ViewGroup，并且必须设定attachToRoot为true。
